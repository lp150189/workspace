...
public class testingMain {
	...
	{
		ArrayLinkedList testLinkedList = new ArrayLinkedList();
		...
		testLinkedList.insertAfter(19.5, 1);
		testLinkedList.print();
		

		//5th part: insert a node of value 13.6 to the tail of the list
		testLinkedList.insertAfter(13.60, testLinkedList.size);
		testLinkedList.print();
		test2ByHuyLe();
	...
	public static void test2ByHuyLe(){
		ArrayLinkedList secondTestLinkedList = new ArrayLinkedList();
		...
		secondTestLinkedList.removeAny(4);
		secondTestLinkedList.print();
